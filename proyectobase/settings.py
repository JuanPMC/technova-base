"""
Django settings for proyectobase project.
...
LOCAL_HOSTING = os_getenv("LOCAL_HOSTING", "True").lower() in ["True", "true", "1", "yes", "y"]
...
# Debug mode only if its on local host
DEBUG = LOCAL_HOSTING
...
ROOT_URLCONF = 'proyectobase.urls'
...
WSGI_APPLICATION = 'proyectobase.wsgi.application'
...
STATIC_URL = "static/"
STATIC_ROOT = os_path.join(BASE_DIR,"dist","static")
MEDIA_URL = "media/"
